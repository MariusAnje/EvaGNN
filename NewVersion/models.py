...
class GraphSage(nn.Module):
    ...
    def __init__(self, num_layers, out_size, batch_size, sample_size, dl, device, gat=False, agg_func='MEAN'):
    ...
    def forward(self, nodes_batch):
        ...
        for _ in range(self.num_layers):
            lower_layer_nodes, lower_samp_neighs, lower_layer_nodes_dict= self._get_unique_neighs_list(lower_layer_nodes, self.sample_size)
            nodes_batch_layers.insert(0, (lower_layer_nodes, lower_samp_neighs, lower_layer_nodes_dict))
        end_s = time.time()
        # fw = open('sample_times.tsv', 'a')
        # fw.write('{}\n'.format(end-start))
        ...
        for index in range(1, self.num_layers+1):
            ...
            # total_time[self.count + index].append(float(end-start))
        ...
        # self.count += 2
        fw = open(str(self.num_layers) + '_layers_' + str(self.sample_size) + "_samples_" + str(self.batch_size) + 'batchesize.tsv', 'a')
        fw.write('{}\t{}\n'.format(end_s-start_s, total_time))

        # print(nodes_batch)
        # print(end_s - start_s)
        # print(total_time)
        os.system("nvidia-smi | grep 'MiB /' >> " + str(self.num_layers) + "_" + str(self.sample_size) + "_" + str(self.batch_size) + ".txt")
    ...
    def _get_unique_neighs_list(self, nodes, num_sample):
        _set = set
        ...
        _unique_nodes_list = list(set.union(*samp_neighs))  ##### selected unique sampled nodes
