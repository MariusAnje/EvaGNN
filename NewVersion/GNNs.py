...
class GNN(object):
    ...
    """
    def __init__(self, adj_matrix, features=None, labels=None, supervised=False, model='gat', n_layer=2, emb_size=128, random_state=1234, device='auto', epochs=5, batch_size=20, sample_size=10, lr=0.7, unsup_loss_type='margin', print_progress=True):
        ...
        self.gnn = GraphSage(n_layer, emb_size, batch_size, sample_size, self.dl, self.device, gat=self.gat)
    ...
    def fit(self):
        ...
        for epoch in range(self.epochs):
            ...
            for index in range(batches):
                ...
                loss_time += float(end-start)
        print("loss_time: ")
        print(loss_time)
        fw = open('loss_times.tsv', 'a')
        fw.write('{}\n'.format(loss_time))
